						...
						<?php if ( $main_fields_active ) : ?>
							<?php foreach ( $attributes['main_fields'] as $field ) :
								...
								if ( $field_config && ! empty( $field_config['search_support'] ) ) :
									...
									if ( $content ) : ?>
                                        <li class="js-es-search-nav__single-item js-es-search-nav__item" data-placeholder="<?php echo ! empty( $field_config['search_settings']['attributes']['data-placeholder'] ) ? $field_config['search_settings']['attributes']['data-placeholder'] : $field_config['label']; ?>"
