...
es_settings_field_render( 'is_single_agent_block_enabled', array(
	'label' => __( 'Show agent block on single property page', 'es' ),
	'type' => 'switcher',
) );

es_settings_field_render( 'is_agent_listings_quantity_views_enabled', array(
	'label' => __( 'Show agent quantity of listing views', 'es' ),
	'type' => 'switcher',
) );

es_settings_field_render( 'is_agent_listings_quantity_savings_enabled', array(
	'label' => __( 'Show agent quantity of listing savings', 'es' ),
	'type' => 'switcher',
) ); ?>
</div>
