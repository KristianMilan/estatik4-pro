...
abstract class Es_Entities_Archive_Page {
	...
	public static function enqueue_assets() {
		...
		wp_enqueue_style( 'es-archive-entities', ES_PLUGIN_URL . 'admin/css/archive-entities.min.css', $deps );
		wp_enqueue_script( 'es-archive-entities', ES_PLUGIN_URL . 'admin/js/entities-list.min.js', array( 'estatik-popup', 'jquery', 'es-admin', 'inline-edit-post' ) );
