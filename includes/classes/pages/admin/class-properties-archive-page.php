				...
				<div class="es-actions__dropdown">
					<ul>
						...
						<?php if ( $post->post_status == 'publish' ) : ?>
							<li><a href="<?php echo es_get_action_post_link( $post_id, 'draft' ); ?>"><?php _e( 'Unpublish', 'es' ); ?></a></li>
						<?php else : ?>
							<li><a href="<?php echo es_get_action_post_link( $post_id, 'publish' ); ?>"><?php _e( 'Publish', 'es' ); ?></a></li>
						<?php endif; ?>
						<li><a href="<?php echo es_get_action_post_link( $post_id, 'copy' ); ?>"><?php _e( 'Duplicate', 'es' ); ?></a></li>
