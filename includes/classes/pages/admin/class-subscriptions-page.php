...
class Es_Subscriptions_Page {
	...
	public static function render() {
		...
		wp_enqueue_style( 'es-admin-subscriptions', plugin_dir_url( ES_FILE ) . 'admin/css/subscriptions.min.css', array( 'es-select2', 'es-admin', 'estatik-popup' ) );
		wp_enqueue_script( 'es-admin-subscriptions', plugin_dir_url( ES_FILE ) . 'admin/js/subscriptions.min.js', array( 'jquery', 'es-admin', 'jquery-ui-sortable', 'estatik-popup' ) );
