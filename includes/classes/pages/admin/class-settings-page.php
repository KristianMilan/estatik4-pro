...
class Es_Settings_Page {
	...
	public static function render() {
		...
		wp_enqueue_style( 'es-admin-settings', plugin_dir_url( ES_FILE ) . 'admin/css/settings.min.css', array( 'es-admin', 'es-select2' ) );
		wp_enqueue_script( 'es-admin-settings', plugin_dir_url( ES_FILE ) . 'admin/js/settings.min.js', array( 'jquery', 'es-admin' ) );
