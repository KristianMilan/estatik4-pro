...
class Es_Data_Manager_Page {
	...
	public static function get_locations_config() {
	    ...
	    return apply_filters( 'es_date_manager_get_locations_config', array(
	        'countries' => array(
                'id' => 'countries',
	            'label' => __( 'Countries', 'es' ),
	            'components' => array( $country['address_component'] ),
                'dependencies' => array( 'states' ),
                'initial' => true,
	 ...
	 */
	public function ajax_restore_term() {
	...
	public static function render() {
        ...
        $f->load_assets();
		wp_enqueue_style( 'es-data-manager', plugin_dir_url( ES_FILE ) . 'admin/css/data-manager.min.css', array( 'es-admin', 'estatik-popup' ) );
		wp_enqueue_script( 'es-data-manager', plugin_dir_url( ES_FILE ) . 'admin/js/data-manager.min.js', array( 'jquery', 'es-admin', 'estatik-popup' ) );
