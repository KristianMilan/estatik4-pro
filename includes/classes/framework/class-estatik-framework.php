...
class Es_Framework {
    ...
    public function load_scripts() {
        ...
        wp_enqueue_style( 'es-datetime-picker', $url . 'css' . DS . 'jquery.datetimepicker.min.css', false, null );
        wp_enqueue_script( 'wp-color-picker' );
        wp_enqueue_script( 'es-datetime-picker', $url . 'js' . DS . 'jquery.datetimepicker.full.min.js', array( 'jquery' ) );
        wp_enqueue_script( 'es-framework', $url . 'js' . DS . 'framework.js', array( 'jquery', 'es-select2', 'jquery-ui-sortable', 'es-datetime-picker' ) );
