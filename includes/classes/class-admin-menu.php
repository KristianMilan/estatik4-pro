...
class Es_Admin_Menu {
	...
	public static function init() {
		...
		add_action( 'admin_head', array( 'Es_Admin_Menu', 'menu_order_count' ) );
	}
	...
	public static function register_admin_pages() {
		$parent = ests( 'is_white_label_enabled' ) ? 'estatik' : 'es_dashboard';
		$function = ests( 'is_white_label_enabled' ) ? null : array( 'Es_Dashboard_Page', 'render' );
