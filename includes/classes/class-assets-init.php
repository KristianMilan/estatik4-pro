...
class Es_Assets {
	...
	public static function admin_assets() {
		wp_register_script( 'es-admin', ES_PLUGIN_URL . 'admin/js/admin.min.js', array( 'jquery', 'clipboard', 'es-select2' ) );
		wp_register_style( 'es-admin', ES_PLUGIN_URL . 'admin/css/admin.min.css' );
		...
		wp_register_script( 'es-property-metabox', ES_PLUGIN_URL . 'admin/js/property-metabox.min.js', $deps );
		...
		if ( 'widgets.php' === $pagenow || ( $pagenow == 'edit-tags.php' && ! empty( $_GET['taxonomy'] ) && $_GET['taxonomy'] == 'es_location' ) ) {
			...
			wp_enqueue_style( 'es-locations', ES_PLUGIN_URL . 'admin/css/locations.min.css' );
		} else {
			wp_enqueue_script( 'es-admin' );
		}
	}
	...
	public static function register_global_assets() {
		...
		wp_register_style( 'es-select2', $common . '/select2/select2.min.css'  );

		wp_register_style( 'estatik-popup', $common . '/estatik-popup/estatik-popup.css' );
		wp_register_script( 'estatik-popup', $common . '/estatik-popup/estatik-popup.js', array( 'jquery' ) );

		wp_register_style( 'estatik-progress', $common . '/estatik-progress/estatik-progress.css' );
		wp_register_script( 'estatik-progress', $common . '/estatik-progress/estatik-progress.js', array( 'jquery' ) );

		wp_register_script( 'es-slick', $common . '/slick/slick-fixed.min.js', array( 'jquery' ) );
		wp_register_style( 'es-slick', $common . '/slick/slick.min.css' );
		...
		if ( ests( 'google_api_key' ) ) {
			...
			wp_register_script( 'es-googlemap-osm', $public . '/js/osm.min.js' );
			wp_register_script( 'es-googlemap-popup', $public . '/js/gm-popup.min.js' );
			wp_register_script( 'es-googlemap-clusters-api', $public . '/js/markerclustererplus.min.js' );
	...
	public static function frontend_assets() {
		...
		wp_register_script( 'es-property-metabox', ES_PLUGIN_URL . 'admin/js/property-metabox.min.js', $management_deps );
		...
		wp_register_script( 'es-magnific', $common . '/magnific-popup/jquery.magnific-popup.min.js', array( 'jquery' ) );
		...
		wp_register_script( 'es-frontend', $public . '/js/public.min.js', $public_deps );
		wp_enqueue_script( 'es-frontend' );

		wp_register_script( 'es-properties', ES_PLUGIN_URL . 'public/js/ajax-entities.min.js', array( 'es-frontend' ) );
		...
		$localize = array(
			...
			'settings' => array(
				...
				'request_form_geolocation_enabled' => 1,
		...
		wp_enqueue_style( 'es-frontend', $public . '/css/public.min.css', array( 'es-select2', 'es-slick', 'es-magnific' ) );
